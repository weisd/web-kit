...
func (*LoginRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{0} }
...
func (c *aPIServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := grpc.Invoke(ctx, "/user.APIService/Login", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("api/protobuf/user/api.proto", fileDescriptorApi) }
