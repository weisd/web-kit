...
func RegisterAPIServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client APIServiceClient) error {
	...
	mux.Handle("POST", pattern_APIService_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_APIService_Login_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_APIService_Login_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "user", "v1", "login"}, ""))
)
